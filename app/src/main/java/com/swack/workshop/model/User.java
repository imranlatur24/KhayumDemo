...
public class User {
    ...
    public String getUser_ticket_no() {
        return user_ticket_no;
    }

    public void setUser_ticket_no(String user_ticket_no) {
        this.user_ticket_no = user_ticket_no;
    }
